...
@media(max-width:650px){
  ...
  [data-testid="stPlotlyChart"] .barlayer text{font-size:9px!important;font-weight:700!important;writing-mode:vertical-lr!important;text-orientation:mixed!important}
}
@media(max-width:420px){
  [data-testid="stPlotlyChart"] .js-plotly-plot,
  [data-testid="stPlotlyChart"] .plot-container,
  [data-testid="stPlotlyChart"] .svg-container{min-width:720px!important}
  [data-testid="stPlotlyChart"] .barlayer text{font-size:8px!important;font-weight:700!important;writing-mode:vertical-lr!important;text-orientation:mixed!important}
}
