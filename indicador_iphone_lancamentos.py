...
.stTabs,.stTabs>div{overflow:visible!important}.stTabs [data-baseweb="tab-list"]{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px;width:100%;height:auto!important;overflow:visible!important;padding:12px 0 16px!important;border:0!important}.stTabs [data-baseweb="tab-border"],.stTabs [data-baseweb="tab-highlight"]{display:none!important}.stTabs [data-baseweb="tab"]{display:flex!important;align-items:center!important;justify-content:center!important;width:100%!important;min-width:0!important;min-height:58px!important;height:auto!important;padding:10px!important;border:1px solid #ccc;border-radius:10px;background:#fff;overflow:visible!important}.stTabs [data-baseweb="tab"] p{margin:0!important;font-size:clamp(12px,1vw,15px)!important;line-height:1.2!important;white-space:normal!important;overflow:visible!important;text-align:center;font-weight:750}.stTabs [aria-selected="true"]{background:#E30613!important;border-color:#E30613!important}.stTabs [aria-selected="true"] p{color:#fff!important}
...
@media(max-width:900px){.stTabs [data-baseweb="tab-list"]{grid-template-columns:repeat(2,minmax(0,1fr))}.hero{grid-template-columns:90px 1fr 70px}.hero img{max-width:85px;max-height:48px}}
@media(max-width:650px){.block-container{padding:2.6rem .45rem 1rem}.hero{grid-template-columns:55px 1fr 45px;gap:5px}.hero img{max-width:52px;max-height:38px}.hero h1{font-size:19px}.kpi{min-height:80px}.kpi-num{font-size:26px}.kpi-lbl{font-size:12px}.stTabs [data-baseweb="tab-list"]{gap:5px}.stTabs [data-baseweb="tab"]{min-height:48px!important}.stTabs [data-baseweb="tab"] p{font-size:11px!important}}
