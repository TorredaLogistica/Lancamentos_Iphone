...
.stTabs{margin:12px 0 18px!important;overflow:visible!important}.stTabs>div{overflow:visible!important}
.stTabs [data-baseweb="tab-list"]{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:12px!important;width:100%!important;height:auto!important;overflow:visible!important;padding:8px 0 14px!important;border:0!important;background:transparent!important}
.stTabs [data-baseweb="tab-border"],.stTabs [data-baseweb="tab-highlight"]{display:none!important}
.stTabs [data-baseweb="tab"]{display:flex!important;align-items:center!important;justify-content:center!important;width:100%!important;max-width:none!important;min-width:0!important;min-height:58px!important;height:auto!important;padding:12px 14px!important;border:1px solid #D7D7D7!important;border-radius:12px!important;background:#FFFFFF!important;color:#333!important;box-shadow:0 2px 7px rgba(0,0,0,.08)!important;transition:all .18s ease!important;overflow:visible!important;cursor:pointer!important}
.stTabs [data-baseweb="tab"]:hover{border-color:#E30613!important;background:#FFF5F6!important;transform:translateY(-1px)!important;box-shadow:0 4px 12px rgba(227,6,19,.16)!important}
.stTabs [data-baseweb="tab"] p{display:block!important;margin:0!important;font-size:clamp(13px,1.05vw,16px)!important;line-height:1.25!important;white-space:normal!important;overflow:visible!important;text-overflow:clip!important;text-align:center!important;font-weight:750!important;color:inherit!important}
.stTabs [aria-selected="true"]{background:linear-gradient(135deg,#E30613 0%,#B40010 100%)!important;border-color:#E30613!important;color:#FFF!important;box-shadow:0 5px 14px rgba(227,6,19,.28)!important}
...
@media(max-width:900px){.stTabs [data-baseweb="tab-list"]{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px!important}.hero{grid-template-columns:90px 1fr 70px}.hero img{max-width:85px;max-height:48px}}
@media(max-width:650px){.block-container{padding:2.6rem .45rem 1rem}.hero{grid-template-columns:55px 1fr 45px;gap:5px}.hero img{max-width:52px;max-height:38px}.hero h1{font-size:19px}.kpi{min-height:80px}.kpi-num{font-size:26px}.kpi-lbl{font-size:12px}.stTabs [data-baseweb="tab-list"]{grid-template-columns:1fr!important;gap:7px!important}.stTabs [data-baseweb="tab"]{min-height:48px!important;padding:10px 8px!important}.stTabs [data-baseweb="tab"] p{font-size:12px!important}}
